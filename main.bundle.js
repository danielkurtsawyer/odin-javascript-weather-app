"use strict";
(self["webpackChunkodin_javascript_weather_app"] = self["webpackChunkodin_javascript_weather_app"] || []).push([["main"],{
...
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,UAAU;EACV,SAAS;EACT,sBAAsB;AACxB;;AAEA;EACE,wBAAwB;EACxB,uBAAuB;EACvB,qBAAqB;EACrB,uBAAuB;EACvB,mCAAmC;AACrC;;AAEA;EACE,oBAAoB;EACpB,6DAAsD;EACtD,iBAAiB;EACjB,gBAAgB;AAClB;;AAEA;EACE,iBAAiB;EACjB,gBAAgB;EAChB,aAAa;EACb,iCAAiC;;EAEjC,oBAAoB;AACtB;;AAEA;EACE,sCAAsC;EACtC,kBAAkB;EAClB,eAAe;EACf,aAAa;EACb,2CAA2C;EAC3C,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,SAAS;EACT,iBAAiB;EACjB,cAAc;EACd,iBAAiB;EACjB,iBAAiB;;EAEjB,mCAAmC;EACnC,kBAAkB;;EAElB,qCAAqC;AACvC;;AAEA;EACE,0BAA0B;EAC1B,8BAA8B;AAChC;;AAEA;EACE,wBAAwB;AAC1B;;AAEA;EACE,sCAAsC;EACtC,YAAY;EACZ,WAAW;;EAEX,aAAa;EACb,sBAAsB;EACtB,2BAA2B;EAC3B,SAAS;EACT,oBAAoB;AACtB;;AAEA;EACE,mCAAmC;EACnC,iBAAiB;EACjB,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,SAAS;EACT,eAAe;AACjB;;AAEA;EACE,cAAc;AAChB;;AAEA;EACE,WAAW;EACX,UAAU;AACZ;;;AAGA;EACE,aAAa;EACb,sBAAsB;EACtB,SAAS;EACT,+BAA+B;EAC/B,YAAY;EACZ,OAAO;EACP,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,+BAA+B;EAC/B,eAAe;EACf,mBAAmB;AACrB;;AAEA;EACE,gGAAgG;EAChG,WAAW;EACX,UAAU;AACZ;;AAEA;EACE,YAAY;;EAEZ,mBAAmB;EACnB,mCAAmC;EACnC,iBAAiB;;EAEjB,oBAAoB;EACpB,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,kBAAkB;AACpB;;AAEA;EACE,OAAO;AACT;;AAEA;EACE,aAAa;EACb,YAAY;EACZ,8CAA8C;EAC9C,qBAAqB;EACrB,mBAAmB;EACnB,qBAAqB;EACrB,YAAY;EACZ,cAAc;AAChB;;AAEA;EACE;IACE,YAAY;EACd;AACF;;AAEA;EACE,mCAAmC;EACnC,mBAAmB;EACnB,qCAAqC;;EAErC,aAAa;EACb,mCAAmC;EACnC,qBAAqB;EACrB,mBAAmB;AACrB;;AAEA;EACE,WAAW;EACX,YAAY;AACd;;AAEA;EACE,UAAU;EACV,WAAW;AACb;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,eAAe;EACf,aAAa;EACb,6BAA6B;EAC7B,UAAU;AACZ;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,0BAA0B,EAAE,eAAe;EAC3C,8BAA8B,EAAE,SAAS;EACzC,kBAAkB;EAClB,YAAY;EACZ,aAAa;EACb,kCAAkC;EAClC,YAAY;AACd;;AAEA;EACE,KAAK,uBAAuB,EAAE;EAC9B,OAAO,yBAAyB,EAAE;AACpC","sourcesContent":["* {\n  padding: 0;\n  margin: 0;\n  box-sizing: border-box;\n}\n\n:root{\n  --primary-color: #bcf3ff;\n  --medium-color: #8ADCFF;\n  --dark-color: #3188EF;\n  --accent-color: #fff2bc;\n  font-size: clamp(14px, 2.5vw, 18px);\n}\n\n@font-face {\n  font-family: 'Kanit';\n  src: url('./fonts/Kanit-Regular.ttf') format(truetype);\n  font-weight: bold;\n  font-style: none;\n}\n\nbody{\n  min-height: 100vh;\n  min-width: 100vw;\n  display: grid;\n  grid-template-rows: 80px 1fr 30px;\n\n  font-family: 'Kanit';\n}\n\nheader{\n  background-color: var(--primary-color);\n  padding: 12px 15px;\n  font-size: 2rem;\n  display: grid;\n  grid-template-columns: max-content 1fr 60px;\n  align-items: center;\n}\n\n.temp-unit {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  font-size: 1.5rem;\n  grid-column: 3;\n  justify-self: end;\n  padding: 5px 10px;\n\n  border: 2px solid var(--dark-color);\n  border-radius: 6px;\n\n  background-color: var(--medium-color);\n}\n\n.temp-unit div:hover{\n  color: var(--accent-color);\n  text-shadow: 1px 1px 2px black;\n}\n\n.selected {\n  color: var(--dark-color);\n}\n\n.main-wrapper {\n  background-color: var(--primary-color);\n  height: 100%;\n  width: 100%;\n\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n  gap: 24px;\n  padding-bottom: 24px;\n}\n\nfooter {\n  background-color: var(--dark-color);\n  padding: 0px 20px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 12px;\n  font-size: 12px;\n}\n\nfooter a{\n  color: #efd931;\n}\n\n.user-input img {\n  height: 80%;\n  width: 80%;\n}\n\n\n.user-input {\n  display: flex; \n  flex-direction: column;\n  gap: 10px;\n  width: clamp(250px, 35%, 370px);\n  margin: auto;\n  flex: 0;\n  height: fit-content;\n}\n\n.search-wrapper {\n  display: grid;\n  grid-template-columns: 1fr 30px;\n  column-gap: 6px;\n  align-items: center;\n}\n\n.search-wrapper img:hover {\n  filter: invert(85%) sepia(48%) saturate(269%) hue-rotate(336deg) brightness(106%) contrast(103%);\n  height: 90%;\n  width: 90%;\n}\n\ninput {\n  height: 30px;\n\n  border-radius: 10px;\n  border: 2px solid var(--dark-color);\n  padding-left: 4px;\n\n  font-family: 'Kanit';\n  font-size: 1rem;\n}\n\n.location {\n  text-align: center;\n  font-size: 1.25rem;\n}\n\n.forecast-display{\n  flex: 1;\n}\n\n.forecast-wrapper {\n  display: grid;\n  width: 930px;\n  grid-template-columns: repeat(auto-fit, 300px);\n  grid-auto-rows: 300px;\n  align-items: center;\n  justify-items: center;\n  margin: auto;\n  gap: 10px 10px;\n}\n\n@media(max-width: 920px){\n  .forecast-wrapper{\n    width: 300px;\n  }\n}\n\n.forecast-wrapper>div{\n  border: 3px solid var(--dark-color);\n  border-radius: 24px;\n  background-color: var(--medium-color);\n\n  display: grid;\n  grid-template-rows: 1fr 1fr 2fr 1fr;\n  justify-items: center;\n  align-items: center;\n}\n\ndiv.day0 {\n  width: 100%;\n  height: 100%;\n}\n\ndiv.day1, div.day2{\n  width: 90%;\n  height: 90%;\n}\n\n.precip-wrapper {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.date {\n  font-size: 24px;\n}\n\n.temp {\n  font-size: 36px;\n  display: flex;\n  justify-content: space-around;\n  width: 80%;\n}\n\n.day1 .temp, .day2 .temp{\n  font-size: 24px;\n}\n\nimg.condition{\n  height: 90%;\n}\n\n.precip-wrapper img{\n  height: 30px;\n}\n\n.precip {\n  font-size: 24px;\n}\n\n.loader {\n  border: 16px solid #f3f3f3; /* Light grey */\n  border-top: 16px solid #3498db; /* Blue */\n  border-radius: 50%;\n  width: 120px;\n  height: 120px;\n  animation: spin 2s linear infinite;\n  margin: auto;\n}\n\n@keyframes spin {\n  0% { transform: rotate(0deg); }\n  100% { transform: rotate(360deg); }\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony export */ });
/* harmony import */ var _loadForecast_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./loadForecast.js */ "./src/loadForecast.js");
/* harmony import */ var _img_search_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./img/search.svg */ "./src/img/search.svg");
/* harmony import */ var _img_raindrop_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./img/raindrop.svg */ "./src/img/raindrop.svg");
...
const pageLoad = () => {
  ...
  for(let i = 0; i<3; i++){
    ...
    precipitationImg.src = _img_raindrop_svg__WEBPACK_IMPORTED_MODULE_2__;
...
const updateWeather = async (query, celsius, oldLocation) => {
  const weatherData = await (0,_loadForecast_js__WEBPACK_IMPORTED_MODULE_0__.loadForecast)('d2491c9705b6473dba6190239243001', query, 3, celsius);
...
_domController_js__WEBPACK_IMPORTED_MODULE_1__.updateWeather('Pittsburgh', false);
...
const extractData = function extractDailyWeatherData(weatherData, celsius){
  ...
  weatherData.forecast.forecastday.forEach((day) => {
    ...
    const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(new Date(date.split('-')), 'EEEE, MMM d y');
...
/***/ "./src/img/raindrop.svg":
/*!******************************!*\
  !*** ./src/img/raindrop.svg ***!
  \******************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "691dee6f9727b92b7089.svg";
